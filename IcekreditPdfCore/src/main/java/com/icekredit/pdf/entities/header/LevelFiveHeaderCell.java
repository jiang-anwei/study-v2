 ...
 */
public class LevelFiveHeaderCell extends HeaderCell {
    public static final float DEFAULT_VISIBLE_CELL_HEIGHT = 26;
    public static final float DEFAULT_CELL_NOTE_HEIGHT = 16;

    private static final BaseColor CELL_BACKGROUND_COLOR = new BaseColor(0xee,0xee,0xee,0xff);
    private static final BaseColor DEFAULT_VISIBLE_BORDER_COLOR_LEFT = new BaseColor(0xee,0xee,0xee,0xff);
    ...
    private static BaseColor LEVEL_THREE_HEADER_FONT_COLOR = new BaseColor(0x33,0x33,0x33,0xff);

    public LevelFiveHeaderCell(String headerName) {
        this(headerName, "");
    }

    public LevelFiveHeaderCell(String headerName, String headerDesc){
    ...
    public static void main(String [] args){
        ...
        try {
            ...
            LevelFiveHeaderCell headerCell = new LevelFiveHeaderCell("與情分数","分数");
